...
provider "azurerm" {
  alias           = "azure_shared"
  subscription_id = var.provider_shared_subscription_id
  tenant_id       = var.provider_shared_tenant_id
  client_id       = var.provider_shared_client_id
  client_secret   = var.provider_shared_client_secret
  features {}
}
